...
public class FindPanelViewModel: ObservableObject {
    enum Notifications {
    ...
    @Published public var findMatches: [NSRange] = []
    @Published public var currentFindMatchIndex: Int?
    ...
    public init(target: FindPanelTarget) {
        self.target = target
