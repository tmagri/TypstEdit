...
struct ToolbarView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            // Row 1: Text Formatting (Layout & Font)
            HStack(spacing: 8) {
                // Group 1: Layout
            ...
            // Row 2: Structure & Objects (Paragraph, References, Insert)
            HStack(spacing: 8) {
                // Group 3: Paragraph
                ...
                ToolbarGroup(title: "Insert") {
                    ...
                    ToolbarButton(icon: "function", tooltip: "Insert Symbol", isActive: controller.showSymbolPicker) {
                        controller.showSymbolPicker.toggle()
                    }
